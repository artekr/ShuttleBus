 ...
 */
@ParseClassName("Wednesday")
public class Wednesday extends ParseObject {
    ...
    public static ParseQuery<Wednesday> getQuery() {
        return ParseQuery.getQuery(Wednesday.class);
    }
